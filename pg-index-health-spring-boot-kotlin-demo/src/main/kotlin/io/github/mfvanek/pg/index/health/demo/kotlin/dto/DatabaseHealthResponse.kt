...
class DatabaseHealthResponse(
    @field:Schema(
        ...
        example = """["bloated_tables:0", "tables_with_missing_indexes:0", "tables_without_primary_key:1", 
            "duplicated_indexes:2", "foreign_keys_without_index:5", "bloated_indexes:0", "indexes_with_null_values:1", 
            "intersected_indexes:3", "invalid_indexes:1", "unused_indexes:8", "tables_without_description:0", 
            "columns_without_description:1", "columns_with_json_type:0", "columns_with_serial_types:0", 
            "functions_without_description:0", "indexes_with_boolean:1", "not_valid_constraints:1", 
